            ...
            <div className="flex items-center justify-between gap-4 relative z-15">
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-[#8B5CF6] to-[#6366F1] hover:from-[#A78BFA] hover:to-[#8B5CF6] text-white rounded-full flex items-center gap-2 shadow-sm font-display text-[10px] font-black uppercase tracking-widest cursor-pointer border-none"
                >
                  {isPlaying ? (
                    <>
